...
@section('content')
       ...
       <div class="tab-heading mt-4 d-flex justify-content-between align-items-center px-3">
        <h2 class="clr-3b3b3b font-poppins">Additional Activities</h2>
     <a href="./Add-Additional-Activities">  <button class=" btn add-btn width-fit-content"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" width="20px" stroke="currentColor" class="size-6">
                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"></path>
            </svg> Additional Activities
        </button>
        </a>
    </div>

        <div class="table-responsive font-poppins  mt-3">
        <table class="table  align-middle equal-cols-activity">
            <thead class="background-clr-fdfdfd">
                <tr class="font-14 clr-3b3b3b border-top-1px-555 border-bottom-1px-555">
                    ...
                    <th class="font-14 clr-3b3b3b fw-500 font-poppins">Activity name</th>
            ...
            <tbody>
                <tr class=" border-top-1px-555 border-bottom-1px-555">
                    ...
                    <td class="font-14 clr-3b3b3b fw-400 font-poppins">Zipline adventure</td>
                 ...
                 <tr class=" border-top-1px-555 border-bottom-1px-555">
                    ...
                    <td class="font-14 clr-3b3b3b fw-400 font-poppins">Sunset boat ride</td>
